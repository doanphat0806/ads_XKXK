...
export const ORDER_COLUMN_CONFIG = [
  ...
  { id: 'orderSizeS', header: 'ĐH S', group: 'datHang', width: 70, type: 'text', editable: true, align: 'center' },
  { id: 'orderSizeM', header: 'ĐH M', group: 'datHang', width: 70, type: 'text', editable: true, align: 'center' },
  { id: 'orderSizeL', header: 'ĐH L', group: 'datHang', width: 70, type: 'text', editable: true, align: 'center' },
  { id: 'orderSizeXL', header: 'ĐH XL', group: 'datHang', width: 70, type: 'text', editable: true, align: 'center' },
  { id: 'orderSizeFZ', header: 'ĐH FZ', group: 'datHang', width: 70, type: 'text', editable: true, align: 'center' },
