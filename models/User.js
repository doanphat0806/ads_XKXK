...
const UserSchema = new mongoose.Schema({
  ...
  dailyOneMessageSpendLimit: { type: Number },
  dailyFewMessageThreshold: { type: Number },
  dailyFewMessageSpendLimit: { type: Number },
  dailyCheapMessageCostLimit: { type: Number },
  dailyCheapMessageSpendLimit: { type: Number },
  ...
  lifetimeOneMessageSpendLimit: { type: Number },
  lifetimeFewMessageThreshold: { type: Number },
  lifetimeFewMessageSpendLimit: { type: Number },
  lifetimeCheapMessageCostLimit: { type: Number },
  lifetimeCheapMessageSpendLimit: { type: Number },
  ...
  autoPauseCpoLimitLifetime: { type: Number },
  autoPauseZeroOrderSpendLimit: { type: Number },
  autoPauseZeroOrderSpendLimitLifetime: { type: Number },
